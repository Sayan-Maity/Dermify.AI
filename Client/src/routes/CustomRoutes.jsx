...
import SymptomChecker from "../pages/dashboardPages/SymptomChecker";
...
const CustomRoutes = () => {
  return (
    <Routes>
      ...
      {/* -----------------------  PRIVATE ROUTES  --------------------- */}
      <Route exact path="/private" element={<PrivateRoutes element={Sidebar} />}>
        ...
        <Route exact path="/private/symptom-checker" element={<PrivateRoutes element={SymptomChecker} />} />
